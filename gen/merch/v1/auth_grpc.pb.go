...
const (
	AuthService_Authenticate_FullMethodName = "/merch.v1.AuthService/Authenticate"
	AuthService_GetUserID_FullMethodName    = "/merch.v1.AuthService/GetUserID"
	AuthService_GetUsernames_FullMethodName = "/merch.v1.AuthService/GetUsernames"
)
...
func (c *authServiceClient) GetUsernames(ctx context.Context, in *GetUsernamesRequest, opts ...grpc.CallOption) (*GetUsernamesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUsernamesResponse)
	err := c.cc.Invoke(ctx, AuthService_GetUsernames_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) GetUsernames(context.Context, *GetUsernamesRequest) (*GetUsernamesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUsernames not implemented")
}
...
func _AuthService_GetUsernames_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUsernamesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetUsernames(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_GetUsernames_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetUsernames(ctx, req.(*GetUsernamesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "merch.v1.AuthService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_GetUsernames_Handler,
		},
	},
